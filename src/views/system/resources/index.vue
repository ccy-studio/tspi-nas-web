	...
	<div class="system-menu-container layout-pd">
		<el-card shadow="hover">
			<div class="system-menu-search mb15">
				<el-input size="default" placeholder="关键字查询" style="max-width: 180px"> </el-input>

				<el-select v-model="state.query.resType" class="ml10" clearable placeholder="Select" style="width: 240px">
